    ...
    <div id="privacy-policy-id" className='flex flex-col w-full h-full'>
      ...
      <div className="Fold1 flex flex-col h-full lg:max-w-[1090px] px-5 lg:px-20 items-center mt-5 lg:mt-20 m-0 lg:m-auto">
        ...
        <div className='flex flex-col justify-center align-top pt-[53px] pb-[60px] max-w-[930px] mx-auto'>
          ...
          <h3 className='font-Mulish text-[24px] leading-[23px] font-bold self-start mt-[24px] mb-[8px]'>Types of Data Collected</h3>
          ...
          <h4 className='font-Mulish text-[20px] leading-[25px] font-bold self-start mt-[24px] mb-[8px]'>1. Personal Data</h4>
          ...
          <h4 className='font-Mulish text-[20px] leading-[25px] font-bold self-start mt-[24px] mb-[8px]'>2. Usage Data</h4>
          ...
          <h4 className='font-Mulish text-[20px] leading-[25px] font-bold self-start mt-[24px] mb-[8px]'>3. Location Data</h4>
          ...
          <h4 className='font-Mulish text-[20px] leading-[25px] font-bold self-start mt-[24px] mb-[8px]'>4.Tracking Cookies Data</h4>
          ...
          <h3 className='font-Mulish text-[24px] leading-[23px] font-bold self-start mt-[24px] mb-[8px]'>Use Of Data</h3>
          ...
          <h3 className='font-Mulish text-[24px] leading-[23px] font-bold self-start mt-[24px] mb-[8px]'>Security Of Data</h3>
          ...
          <h3 className='font-Mulish text-[24px] leading-[23px] font-bold self-start mt-[24px] mb-[8px]'>Delete Your Data</h3>
          ...
          <h3 className='font-Mulish text-[24px] leading-[23px] font-bold self-start mt-[24px] mb-[8px]'>Third Party Advertisers</h3>
          ...
          <h3 className='font-Mulish text-[24px] leading-[23px] font-bold self-start mt-[24px] mb-[8px]'>General Data Protection Regulation (GDPR)</h3>
          ...
          <h3 className='font-Mulish text-[24px] leading-[23px] font-bold self-start mt-[24px] mb-[8px]'>Children’s Privacy</h3>
          ...
          <h3 className='font-Mulish text-[24px] leading-[23px] font-bold self-start mt-[24px] mb-[8px]'>Changes to This Privacy Policy</h3>
